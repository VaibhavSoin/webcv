...
<button onclick="se(); reset(); return false">MAIL</button>
            <script src="https://smtpjs.com/v3/smtp.js"></script>
            <script>
                function se(){
                Email.send({
    Host : "smtp.elasticemail.com",
    Username : "vaibhavsoin2@gmail.com",
    Password : "6582F152D17C593036164D58651EF41C5AE2",
    To : <?php echo $row["email"]?>,
    From : "vaibhavsoin2@gmail.com",
    Subject : "mail",
    Body : "CV SUCCESSFUL+<br>+PLS FILL FEED FORM+<br>+https://docs.google.com/forms/d/e/1FAIpQLSeo7smefpWMkdfwAHuyiAaTq2HbFIqPYiLLcp8LXB_PVgyixw/viewform?usp=sf_link",
